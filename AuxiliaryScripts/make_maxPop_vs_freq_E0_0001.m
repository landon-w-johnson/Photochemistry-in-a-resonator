...
for omega = [0.355,0.356,0.357,0.358,0.362,0.363,0.364]
    omegaString = num2str(omega);
    nonRWApath = strcat("NoRWA/E0.0001_w",omegaString,"/dataFile.txt");
    RWApath = strcat("RWA/E0.0001_w",omegaString,"/dataFile.txt");
...
figName = "plot_maxPop_vs_freq_E0.0001.png";
saveas(f1, figName);
