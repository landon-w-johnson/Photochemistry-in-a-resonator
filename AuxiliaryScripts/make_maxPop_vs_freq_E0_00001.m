...
for omega = [0.355,0.356,0.357,0.358,0.359,0.361,0.362,0.363,0.364]
    ...
    nonRWApath = strcat("NoRWA/E0.00001_w",omegaString,"/dataFile.txt");
    RWApath = strcat("RWA/E0.00001_w",omegaString,"/dataFile.txt");
...
figName = "plot_maxPop_vs_freq_E0.00001.png";
saveas(f1, figName);
